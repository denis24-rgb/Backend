...
public class EmailService {
  ...
  public void enviarCorreoVerificacion(String para, String token) {
    String urlVerificacion = "http://192.168.2.108:8084/api/usuarios/confirmar?token=" + token;
  ...
  public void enviarCorreoLoginNuevoDispositivo(String correo, String token) {
    String urlLogin = "http://192.168.2.108:8084/api/usuarios/confirmar-login?token=" + token;

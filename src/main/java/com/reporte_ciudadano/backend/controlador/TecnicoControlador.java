...
// Optional<UsuarioInstitucional> tecnicoOptional =
// usuarioServicio.obtenerPorId(tecnicoId);
...
// long totalPendientes = reporteServicio.contarPorTecnicoYEstado(tecnicoId,
// "RECIBIDO");
// long totalProceso = reporteServicio.contarPorTecnicoYEstado(tecnicoId,
// "EN_PROCESO");
// long totalFinalizado = reporteServicio.contarPorTecnicoYEstado(tecnicoId,
// "FINALIZADO");
...
// @ResponseBody
// public List<Reporte> obtenerReportesPorEstado(@RequestParam String estado,
// HttpSession session) {
// Long tecnicoId = (Long) session.getAttribute("usuarioId");
...
// conteos.put("RECIBIDO", reporteServicio.contarPorTecnicoYEstado(tecnicoId,
// "RECIBIDO"));
// conteos.put("EN PROCESO", reporteServicio.contarPorTecnicoYEstado(tecnicoId,
// "EN PROCESO")); // ✔ clave y valor iguales al frontend y base
// conteos.put("FINALIZADO", reporteServicio.contarPorTecnicoYEstado(tecnicoId,
// "RESUELTO")); // ✔ clave que espera el frontend
// return conteos;
// }
...
// @ResponseBody
// public List<Reporte> filtrarReportesPorEstado(@RequestParam String estado,
// HttpSession session) {
// Long tecnicoId = (Long) session.getAttribute("usuarioId");
// return (tecnicoId == null) ? List.of() :
// reporteServicio.listarPorTecnicoYEstado(tecnicoId, estado);
// }
